...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const controller = new AbortController();
    loadPoolChart(selectedPair.address, controller.signal).then(setChartPoints).catch(() => setChartPoints([]));
    return () => controller.abort();
